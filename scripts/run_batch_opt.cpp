...
int main(int argc, char** argv) {
      ...
      // Run Ceres batch optimization (no per-landmark uncertainties here; pass empty to use default)
      auto [state_estimates, covariance, residuals] = solve_ceres_batch_opt(lm, gs, gm, Eigen::VectorXd{}, od_config.batch_opt);
